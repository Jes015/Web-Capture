  ...
  return (
    ...
    >
      <div
        className={
          clsx(
            'z-50 flex-grow h-full [flex-basis:50vw] flex-shrink-0 flex flex-col justify-center px-5 sm:px-20 lg:px-10 xl:px-20 pb-10 bg-neutral-900 border-r border-r-neutral-800',
            className
          )
        }
        {...props}
